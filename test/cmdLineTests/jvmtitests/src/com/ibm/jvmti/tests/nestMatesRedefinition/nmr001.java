...
public class nmr001 {
	...
	static boolean runRedefinitionTest(int expectedErrorCode, String className, byte[] originalDefinition, byte[] newDefinition) {
		//System.out.println("params:" + expectedErrorCode + "  " + className + "  " + originalDefinition + "  " + newDefinition);
		int redefinitionErrorCode = 0;
		//System.out.println(redefinitionErrorCode);
		try {
		...
		//	System.out.println(instance);
			System.out.println(clazz + "  " + newDefinition.length + "  " + newDefinition);
		...
		//System.out.println(expectedErrorCode + "  " + redefinitionErrorCode);
	...
	public static void main (String[] args) {
		testRedefinitionWithNestHostAttribute();
		testRedefinitionWithNestMembersAttribute();
		
		testRedefinitionAddingNestHostAttribute();
		testRedefinitionAddingNestMembersAttribute();
		testRedefinitionRemovingNestHostAttribute();
		testRedefinitionRemovingNestMembersAttribute();
		
		testRedefinitionAlteringNestHostAttribute();
		testRedefinitionAlteringNestMembersLength();
		testRedefinitionAlteringNestMembersContent();
	}
